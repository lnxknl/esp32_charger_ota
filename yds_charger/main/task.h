...
#define ota_process if(OTA_FLAG){xTaskCreate(advanced_ota_example_task, "advanced_ota_example_task", 1024 * 8, NULL, 1, NULL);for (;;){vTaskDelay(pdMS_TO_TICKS(1000));}}// @NOTE 
